      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div className="bg-purple-50 rounded-lg p-4">
            <p className="text-sm text-gray-600 mb-1">先攻後攻の勝率差</p>
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-3 gap-4">
                <div className="bg-gray-50 rounded-lg p-3 text-center">
                  <p className="text-xs text-gray-600 mb-1">試合数</p>
                  <p className="text-lg font-bold text-gray-800">
                    {firstPlayerStats.totalGames.toLocaleString()}
                  </p>
                </div>
                <div className="bg-green-50 rounded-lg p-3 text-center">
                  <p className="text-xs text-gray-600 mb-1">勝数</p>
                  <p className="text-lg font-bold text-green-600">
                    {firstPlayerStats.wins}
                  </p>
                </div>
                <div className="bg-red-50 rounded-lg p-3 text-center">
                  <p className="text-xs text-gray-600 mb-1">敗数</p>
              ...
              {/* Progress Bar */}
              <div>
                <p className="text-sm text-gray-600 mb-2">勝敗比率</p>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <div className="space-y-3 text-sm">
            <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
              <span className="text-gray-700">先攻有利度</span>
              <span className={`font-semibold ${
                firstPlayerStats.winRate > 50 ? 'text-green-600' : 'text-red-600'
              }`}>
            ...
            <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
              <span className="text-gray-700">後攻有利度</span>
              <span className={`font-semibold ${
                secondPlayerStats.winRate > 50 ? 'text-green-600' : 'text-red-600'
              }`}>
            ...
            <div className="mt-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
              <p className="text-gray-700">
                {firstPlayerStats.winRate > secondPlayerStats.winRate ? (
                  <>
                    <span className="font-semibold text-blue-700">先攻が有利</span>
                    な環境です。先攻の勝率は
                  ...
                  <>
                    <span className="font-semibold text-blue-700">後攻が有利</span>
                    な環境です。後攻の勝率は
                    <span className="font-semibold"> {secondPlayerStats.winRate.toFixed(1)}%</span>、
                    先攻の勝率は
                    <span className="font-semibold"> {firstPlayerStats.winRate.toFixed(1)}%</span>
                  ...
                  <>
                    <span className="font-semibold text-blue-700">先攻後攻がほぼ同等</span>
                    な環境です。両方とも
                    <span className="font-semibold"> {firstPlayerStats.winRate.toFixed(1)}%</span>
                    の勝率となっています。
                  </>
